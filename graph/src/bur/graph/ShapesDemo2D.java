...
public class ShapesDemo2D extends JApplet {
	...
	public void paint(Graphics g) {
		...
		final int gridWidth = d.width / 6;
		final int gridHeight = d.height / 2;
		...
		int x = 5;
		int y = 7;
		final int rectWidth = gridWidth - 2 * x;
		int stringY = gridHeight - 3 - fontMetrics.getDescent();
		final int rectHeight = stringY - fontMetrics.getMaxAscent() - y - 2;
		...
		final int x1Points[] = { x, x + rectWidth, x, x + rectWidth };
		final int y1Points[] = { y, y + rectHeight, y + rectHeight, y };
		...
		final int x2Points[] = { x, x + rectWidth, x, x + rectWidth };
		final int y2Points[] = { y, y + rectHeight, y + rectHeight, y };
		final GeneralPath polyline = new GeneralPath(GeneralPath.WIND_EVEN_ODD,
				x2Points.length);
		...
		final int x3Points[] = { x, x + rectWidth, x, x + rectWidth };
		final int y3Points[] = { y, y + rectHeight, y + rectHeight, y };
		final GeneralPath filledPolygon = new GeneralPath(GeneralPath.WIND_EVEN_ODD,
				x3Points.length);
	...
	public static void main(String s[]) {
		final JFrame f = new JFrame("ShapesDemo2D");
		...
		final JApplet applet = new ShapesDemo2D();
